...
DEVOLUCOES: list[Devolucao] = [
    ...
    Devolucao(sku="SKU-8802", motivo="Chovi 10 minutos e encharquei", dias_atras=5),
    ...
    Devolucao(sku="SKU-8802", motivo="Passou água na costura do ombro", dias_atras=21),
    ...
    Devolucao(sku="SKU-8802", motivo="Água atravessa o tecido", dias_atras=73),
